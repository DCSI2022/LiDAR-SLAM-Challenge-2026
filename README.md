...
> [!CAUTION]
> **参赛前必须先通过大赛组委会完成正式报名。** 请先在大赛官网下载报名表，填写后
> 发送至组委会邮箱 [lidar2026@126.com](mailto:lidar2026@126.com)，并以收到组委会
> 确认通知为报名成功。**仅加入 Codabench 比赛或在平台提交结果，不等于完成正式报名。**
...
| 正式参赛条件 | **须先向大赛组委会邮箱提交报名表并收到确认；仅加入 Codabench 不视为正式报名** |
...
> [!IMPORTANT]
> **请先完成第 1、2 步，再加入 Codabench 参赛和提交结果。Codabench 报名不能替代大赛组委会邮件报名。**

1. **提交正式报名表（必须）**：在大赛官网下载报名表，填写后发送至大赛组委会邮箱 [lidar2026@126.com](mailto:lidar2026@126.com)。
2. **确认报名资格（必须）**：收到大赛组委会的确认通知后，方视为报名成功。
...
| 日期 | 版本 | 更新内容 |
| --- | --- | --- |
| 2026-09-07 | v1.1 | 强调正式参赛前须先通过大赛组委会邮箱提交报名表并收到确认，Codabench 参赛不能替代邮件报名 |
